...
/*
 * Imaginamos footer signature
 * By: Juan Pablo Solano, Javier VarÃ³n Saavedra
 * Version: 1.0.0
 * Updated: Diciembre 1, 2012
 *
 *
 */
(function($) {
    $.fn.ahorranito = function(options) {
        ...
        var defaults = {
            theme: 'oscuro',
            /*puede ser 'oscuro', 'claro'*/
            type: 1,
            /* 1 = web , 2 = movil , 3 = software*/
            width: '220',
            height: '40',
        ...
        return this.each(function() {
            ...
            var elem = $(this),
                typeOption1 = 'Dise&ntilde;o Web',
                typeOption2 = 'Dise&ntilde;o MÃ³vil',
                typeOption3 = 'Software Web',
                imgIconPath = 'http://www.imaginamos.com/footer_ahorranito/ahorranito-2.png',
                imaginamosLink = 'http://www.imaginamos.com/'


                /*si el theme es oscuro cambiar color de fuente*/
            if (options.theme == 'claro') {
                if (options.fontColor1 == '#39444A') {
                    options.fontColor1 = '#fff'
                }
            };
            ...
            switch (options.type) {
                case 1:
                    typeOptionString = typeOption1;
                    break;
                case 2:
                    typeOptionString = typeOption2;
                    break;
                case 3:
                    typeOptionString = typeOption3;
                    break;
                default:
            }


            /*Classes css del elemento*/
            var elemStyle = {
                'font-size': '12px',
            ...
            /*Calculo de margin superior del icono de imaginamos*/
            var marginTop = (options.height / 2) - (22 / 2);

            /*Classes css del icono de ahorranito*/
            var ahorranitoIconStyle = {
                'background': 'url(' + imgIconPath + ')',
            ...
            /*Classes de la 'a' en imaginAmos*/
            var linksStyleA = {
                'color': options.fontColor2
            };

            /*Creacion de elementos de la firma*/
            elem.css(elemStyle)
                .append(
                    $('<span></span>')
                    .css(ahorranitoIconStyle)
            )
                .append($('<a class="imaginamosOver"></a>')
                    .css(linkStyle)
                    .attr({
                        'href': imaginamosLink,
                        'target': '_blank'
                    })
                    .html(typeOptionString + ' : ')
            )
                .append($('<a class="imaginamosOver"></a>')
                    .css(linkStyle)
                    .attr({
                    ...
                    .html('imagin').append($('<span>a</span>')
                        .css(linksStyleA)
                    )
                    .append('mos.com')
            );

            $('.imaginamosOver').hover(
                function() {
...
(function() {
  ...
  google.maps.Load = function(apiLoad) {
    ...
    apiLoad([0.009999999776482582,[[["https://mts0.googleapis.com/vt?lyrs=m@260000000\u0026src=api\u0026hl=es-ES\u0026","https://mts1.googleapis.com/vt?lyrs=m@260000000\u0026src=api\u0026hl=es-ES\u0026"],null,null,null,null,"m@260000000",["https://mts0.google.com/vt?lyrs=m@260000000\u0026src=api\u0026hl=es-ES\u0026","https://mts1.google.com/vt?lyrs=m@260000000\u0026src=api\u0026hl=es-ES\u0026"]],[["https://khms0.googleapis.com/kh?v=149\u0026hl=es-ES\u0026","https://khms1.googleapis.com/kh?v=149\u0026hl=es-ES\u0026"],null,null,null,1,"149",["https://khms0.google.com/kh?v=149\u0026hl=es-ES\u0026","https://khms1.google.com/kh?v=149\u0026hl=es-ES\u0026"]],[["https://mts0.googleapis.com/vt?lyrs=h@260000000\u0026src=api\u0026hl=es-ES\u0026","https://mts1.googleapis.com/vt?lyrs=h@260000000\u0026src=api\u0026hl=es-ES\u0026"],null,null,null,null,"h@260000000",["https://mts0.google.com/vt?lyrs=h@260000000\u0026src=api\u0026hl=es-ES\u0026","https://mts1.google.com/vt?lyrs=h@260000000\u0026src=api\u0026hl=es-ES\u0026"]],[["https://mts0.googleapis.com/vt?lyrs=t@132,r@260000000\u0026src=api\u0026hl=es-ES\u0026","https://mts1.googleapis.com/vt?lyrs=t@132,r@260000000\u0026src=api\u0026hl=es-ES\u0026"],null,null,null,null,"t@132,r@260000000",["https://mts0.google.com/vt?lyrs=t@132,r@260000000\u0026src=api\u0026hl=es-ES\u0026","https://mts1.google.com/vt?lyrs=t@132,r@260000000\u0026src=api\u0026hl=es-ES\u0026"]],null,null,[["https://cbks0.googleapis.com/cbk?","https://cbks1.googleapis.com/cbk?"]],[["https://khms0.googleapis.com/kh?v=84\u0026hl=es-ES\u0026","https://khms1.googleapis.com/kh?v=84\u0026hl=es-ES\u0026"],null,null,null,null,"84",["https://khms0.google.com/kh?v=84\u0026hl=es-ES\u0026","https://khms1.google.com/kh?v=84\u0026hl=es-ES\u0026"]],[["https://mts0.googleapis.com/mapslt?hl=es-ES\u0026","https://mts1.googleapis.com/mapslt?hl=es-ES\u0026"]],[["https://mts0.googleapis.com/mapslt/ft?hl=es-ES\u0026","https://mts1.googleapis.com/mapslt/ft?hl=es-ES\u0026"]],[["https://mts0.googleapis.com/vt?hl=es-ES\u0026","https://mts1.googleapis.com/vt?hl=es-ES\u0026"]],[["https://mts0.googleapis.com/mapslt/loom?hl=es-ES\u0026","https://mts1.googleapis.com/mapslt/loom?hl=es-ES\u0026"]],[["https://mts0.googleapis.com/mapslt?hl=es-ES\u0026","https://mts1.googleapis.com/mapslt?hl=es-ES\u0026"]],[["https://mts0.googleapis.com/mapslt/ft?hl=es-ES\u0026","https://mts1.googleapis.com/mapslt/ft?hl=es-ES\u0026"]],[["https://mts0.googleapis.com/mapslt/loom?hl=es-ES\u0026","https://mts1.googleapis.com/mapslt/loom?hl=es-ES\u0026"]]],["es-ES","US",null,0,null,null,"https://maps.gstatic.com/mapfiles/","https://csi.gstatic.com","https://maps.googleapis.com","https://maps.googleapis.com"],["https://maps.gstatic.com/intl/es_es/mapfiles/api-3/16/9","3.16.9"],[1762720848],1,null,null,null,null,0,"",null,null,1,"https://khms.googleapis.com/mz?v=149\u0026",null,"https://earthbuilder.googleapis.com","https://earthbuilder.googleapis.com",null,"https://mts.googleapis.com/vt/icon",[["https://mts0.googleapis.com/vt","https://mts1.googleapis.com/vt"],["https://mts0.googleapis.com/vt","https://mts1.googleapis.com/vt"],[null,[[0,"m",260000000]],[null,"es-ES","US",null,18,null,null,null,null,null,null,[[47],[37,[["smartmaps"]]]]],0],[null,[[0,"m",260000000]],[null,"es-ES","US",null,18,null,null,null,null,null,null,[[47],[37,[["smartmaps"]]]]],3],[null,[[0,"m",260000000]],[null,"es-ES","US",null,18,null,null,null,null,null,null,[[50],[37,[["smartmaps"]]]]],0],[null,[[0,"m",260000000]],[null,"es-ES","US",null,18,null,null,null,null,null,null,[[50],[37,[["smartmaps"]]]]],3],[null,[[4,"t",132],[0,"r",132000000]],[null,"es-ES","US",null,18,null,null,null,null,null,null,[[5],[37,[["smartmaps"]]]]],0],[null,[[4,"t",132],[0,"r",132000000]],[null,"es-ES","US",null,18,null,null,null,null,null,null,[[5],[37,[["smartmaps"]]]]],3],[null,null,[null,"es-ES","US",null,18],0],[null,null,[null,"es-ES","US",null,18],3],[null,null,[null,"es-ES","US",null,18],6],[null,null,[null,"es-ES","US",null,18],0],["https://mts0.google.com/vt","https://mts1.google.com/vt"],"/maps/vt"],2,500,["https://geo0.ggpht.com/cbk?cb_client=maps_sv.uv_api_demo","https://www.gstatic.com/landmark/tour","https://www.gstatic.com/landmark/config","/maps/preview/reveal?authuser=0","/maps/preview/log204","/gen204?tbm=map","https://static.panoramio.com.storage.googleapis.com/photos/"]], loadScriptTime);
  };
  var loadScriptTime = (new Date).getTime();
  getScript("https://maps.gstatic.com/intl/es_es/mapfiles/api-3/16/9/main.js");
})();
